...
//Подсказка № 1
// Создайте функция, которая меняет первую строку с последней.
//Подсказка № 2
...
class UserInputToCompileForTest
{
    ...
    public static void PrintArray(int[,] array)
    {
        ...
        for(int i = 0; i < array.GetLength(0); i++)
        {
          ...
          {
            Console.Write($"{array[i, j]}\t"); //"\t": Это символ табуляции (символ табуляции), который добавляется после значения элемента массива. Таким образом, после каждого значения элемента будет добавлен символ табуляции, что обеспечит выравнивание данных в выводе.
          }
          Console.WriteLine();
        }
