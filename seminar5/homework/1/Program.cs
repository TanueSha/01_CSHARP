...
// https://github.com/Zlata839/01_CSHARP подсмотрела
...
// (мой комментарий) 
// Условие задачи говорит, что "Позиции в массиве считать от единицы". 
// Это означает, что пользователь будет вводить номера рядов и колонок, начиная с 1.
// Однако, в C# (и большинстве других языков) индексация массивов начинается с 0. 
// Это значит, что первый элемент в массиве имеет индекс 0, а не 1.
// Поэтому, чтобы сопоставить пользовательский ввод (начинающийся с 1) 
// с индексами массива (начинающимися с 0), нам нужно вычитать 1 из значений x и y, 
// которые передаются в функцию.
// Таким образом, в строке array[x - 1, y - 1]; мы уменьшаем значения x и y на 1, 
// чтобы получить правильные индексы для доступа к элементам массива array.
// Это общая практика при работе с массивами в программировании - приводить пользовательский ввод к внутренним индексам массива.
